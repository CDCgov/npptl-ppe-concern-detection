...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run simulation with a specific seed")
    ...
    eval_pred_fname = "{}eval_pred_split_{}.pkl".format(eval_dir, i_split)
    ...
    overall_metrics.to_csv("{}overall_metrics_{}.csv".format(eval_dir, i_split), encoding='utf-8')
    ...
    marginal_metrics.to_csv("{}marginal_metrics_split_{}.csv".format(eval_dir, i_split), encoding='utf-8')
    ...
    df_test.to_csv("{}df_test_split_{}.csv".format(eval_dir, i_split), encoding='utf-8')
