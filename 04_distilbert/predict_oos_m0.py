...
output_dir = "predict_oos_m0/"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

ppe_unsampled = pd.read_csv("../02_sample-data/ppe_unsampled.csv")

model = AutoModelForSequenceClassification.from_pretrained("model/model0/", local_files_only=True, from_tf=False, config="model/model0/config.json")
tokenizer = AutoTokenizer.from_pretrained("model/model0/")
